...
<template>
    <div class="layout-wrapper">
        <div class="layout-side" :class="{'layout-side-extend': !isCollapse}">
            <div class="layout-logo" v-if="!isCollapse">PocStrike</div>
            <div class="layout-logo" v-else>S</div>
            <el-menu :collapse="isCollapse" :default-active="current_index" @open="handleOpen" @close="handleClose" @select="handleSelect" unique-opened router>
        ...
        <div class="layout-main">
            ...
            <div class="layout-footer">
                Create By <a style="color: #99a9bf" href="">xxxx</a>
            </div>
        </div>
    </div>
</template>
