...
from libs.pocstrike.lib.core.data import paths, logger

from libs.pocstrike.lib.core.common import validate_ip_addr, port_to_hex, port_to_dd, ip_to_hex, ip_to_dd, create_shellcode, \
    read_binary, get_public_type_members
from libs.pocstrike.lib.core.enums import OS, OS_ARCH, SHELLCODE_CONNECTION
...
class ShellcodeToExe:
    def __init__(self, shellcode, target_os, target_arch, filename='', dll_inj_funcs=''):
        ...
        self.path = paths.POCSTRIKE_TMP_PATH
