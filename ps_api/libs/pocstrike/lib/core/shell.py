...
from libs.pocstrike.lib.core import readlineng as readline
from libs.pocstrike.lib.core.data import logger
from libs.pocstrike.lib.core.data import paths
from libs.pocstrike.lib.core.enums import AUTOCOMPLETE_TYPE
from libs.pocstrike.lib.core.enums import OS
from libs.pocstrike.lib.core.settings import MAX_HISTORY_LENGTH
...
def save_history(completion=None):
    ...
    if completion == AUTOCOMPLETE_TYPE.SQL:
        ...
        history_path = paths.POCSTRIKE_CONSOLE_HISTORY
    else:
        history_path = paths.POCSTRIKE_SHELL_HISTORY
