...
from libs.pocstrike.lib.core.common import is_ipv6_address_format, is_ip_address_format
...
class OptIP(Option):
    ...
    def __set__(self, instance, value):
        if not value or is_ip_address_format(value) or is_ipv6_address_format(value):
            ...
            raise PocstrikeValidationException("Invalid address. Provided address is not valid IPv4 or IPv6 address.")
    ...
    def __set__(self, instance, value):
        try:
            ...
            if 0 <= value <= 65535:  # max port number is 65535
                ...
                raise PocstrikeValidationException("Invalid option. Port value should be between 0 and 65536.")
        except ValueError:
            raise PocstrikeValidationException("Invalid option. Cannot cast '{}' to integer.".format(value))
...
class OptBool(Option):
    ...
    def __set__(self, instance, value):
        ...
        if value.lower() == "true":
            ...
            raise PocstrikeValidationException("Invalid value. It should be true or false.")
...
class OptFloat(Option):
    ...
    def __set__(self, instance, value):
        try:
            ...
            raise PocstrikeValidationException("Invalid option. Cannot cast '{}' to float.".format(value))
...
class OptString(Option):
    ...
    def __set__(self, instance, value):
        try:
            ...
            raise PocstrikeValidationException("Invalid option. Cannot cast '{}' to string.".format(value))
...
class OptItems(Option):
    ...
    def __set__(self, instance, value):
        ...
        #     raise PocstrikeValidationException("Cannot set {},you must select {}".format(value, self.default))
        self.value = value
