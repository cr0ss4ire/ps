...
from libs.pocstrike.lib.core.common import data_to_stdout, has_poll, get_unicode, desensitization
from libs.pocstrike.lib.core.data import conf, kb, logger
from libs.pocstrike.lib.core.datatype import AttribDict
from libs.pocstrike.lib.core.enums import AUTOCOMPLETE_TYPE, OS, CUSTOM_LOGGING
...
from libs.pocstrike.lib.core.shell import auto_completion, clear_history, save_history, load_history
from libs.pocstrike.lib.core.threads import exception_handled_function
    ...
    while True:
        ...
        try:
            ...
            if not cmd:
                ...
                clear_history()
                data_to_stdout("[i] history cleared\n")
                save_history(AUTOCOMPLETE_TYPE.POCSTRIKE)
...
def handle_listener_connection():
    ...
    auto_completion(AUTOCOMPLETE_TYPE.POCSTRIKE, commands=_)
    ...
    while True:
        ...
        if not cmd:
            ...
            raise PocstrikeShellQuitException
        elif cmd == "list":
            list_clients()
            ...
            save_history(AUTOCOMPLETE_TYPE.POCSTRIKE)
            load_history(AUTOCOMPLETE_TYPE.POCSTRIKE)
